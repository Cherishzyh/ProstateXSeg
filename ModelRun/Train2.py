    ...
    for cv_index, (sub_train, sub_val) in enumerate(cv_generator):
        ...
        for epoch in range(total_epoch):
            ...
            for ind, (inputs, outputs) in enumerate(train_loader):
                ...
                preds = model(inputs, epoch, is_multipy=True)
...
if __name__ == '__main__':
    ...
    # CheckInput()
    # train_list = pd.read_csv(r'/home/zhangyihong/Documents/ProstateX_Seg_ZYH/train_name.csv').values[0].tolist()
    # val_list = pd.read_csv(r'/home/zhangyihong/Documents/ProstateX_Seg_ZYH/val_name.csv').values[0].tolist()
    # train_list.extend(val_list)
    # new_df = pd.DataFrame(sorted(train_list)).T
    # new_df.to_csv(r'/home/zhangyihong/Documents/ProstateX_Seg_ZYH/all_train_name.csv', index=False)
